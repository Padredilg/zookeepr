...
const printResults = resultArr => {
  ...
  //.map will return data for each element in the object(which is an array)
...
const handleGetAnimalsSubmit = event => {
  ...
  const animalsObject = { diet, personalityTraits };
  //}

  getAnimals(animalsObject);
};
